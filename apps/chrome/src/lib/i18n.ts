...
export const STRINGS = {
  ...
  'renderer.web.export': { zh: '导出', en: 'Export' },
  'renderer.web.skillHint': { zh: '保存为 skill.md，交给 AI 代理或设计工具作为可复用的设计参考', en: 'Save as skill.md — feed into AI agents or design tools as a reusable design reference' },
  ...
  'renderer.web.tokens.overview': { zh: '设计参考 · 概览', en: 'Design Reference · Overview' },
